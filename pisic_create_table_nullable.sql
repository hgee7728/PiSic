...
CREATE TABLE "MEMBER" (
	...
	"M_GRADE"	VARCHAR2(20)	DEFAULT 'ROLE_MEAMBER'	NULL,
    "M_FAIL_CNT"	NUMBER	DEFAULT 0	NULL,
...
--  "MS_PERIOD" NUMBER          NOT NULL,
--  "MS_CUSTOMER_UID" VARCHAR2(50)  NOT NULL,
--  "MS_MERCHANT_UID" VARCHAR2(50)  NOT NULL
--);
...
CREATE TABLE "MEMBERSHIP_INFO" (
    ...
    "MS_PERIOD" NUMBER          NULL,
    "MS_CUSTOMER_UID" VARCHAR2(50)  NULL,
    "MS_MERCHANT_UID" VARCHAR2(50)  NULL
);
...
CREATE TABLE "SOUND_LIKE" (
	...
	"S_NO"	NUMBER		NOT NULL,
	"A_NO"	NUMBER		NOT NULL,
	"LIKE_DATE"	TIMESTAMP	DEFAULT SYSTIMESTAMP	NULL
);

COMMENT ON COLUMN "SOUND_LIKE"."LIKE_DATE" IS '좋아요 한 시간';
...
COMMENT ON COLUMN "ARTIST_LIKE"."LIKE_DATE" IS '좋아요 한 시간';
