...
CREATE TABLE "QNA" (
	...
	"QNA_PASSWORD"	NUMBER		 NULL,
	"M_ID"	VARCHAR2(10)		NOT NULL,
	"QNA_DATE"	TIMESTAMP	DEFAULT SYSTIMESTAMP	NULL
);

COMMENT ON COLUMN "QNA"."QNA_PASSWORD" IS '숫자 4자리 OR 6자리 등등';
...
--	"QNA_AN_NO"	NUMBER		NOT NULL,
--	"QNA_AN_TITLE"	VARCHAR2(100)		NOT NULL,
--	"QNA_AN_CONTENT"	VARCHAR2(500)		NOT NULL,
--	"QNA_NO"	NUMBER		NOT NULL,
--	"M_ID"	VARCHAR2(10)		NOT NULL,
--	"QNA_AN_DATE"	TIMESTAMP	DEFAULT SYSTIMESTAMP	NULL
--);


CREATE TABLE "QNA_ANSWER" (
	"QNA_AN_NO"	NUMBER		NOT NULL,
	"QNA_AN_TITLE"	VARCHAR2(100)		 NULL,
	"QNA_AN_CONTENT"	VARCHAR2(500)		 NULL,
	"QNA_NO"	NUMBER		NOT NULL,
	"M_ID"	VARCHAR2(10)		NOT NULL,
	"QNA_AN_DATE"	TIMESTAMP	DEFAULT SYSTIMESTAMP	NULL
);
...
ALTER TABLE "QNA_ANSWER" ADD CONSTRAINT "FK_MEMBER_TO_QNA_ANSWER_1" FOREIGN KEY (
	"M_ID"
)
REFERENCES "MEMBER" (
	"M_ID"
...
--	"SKY"	VARCHAR2(10)		NOT NULL,
--	"PTY"	VARCHAR2(10)		NOT NULL,
--	"TMP"	NUMBER		NOT NULL
--);
...
CREATE TABLE "PLAYINFO" (
	...
	"SKY"	VARCHAR2(10)		 NULL,
	"PTY"	VARCHAR2(10)		 NULL,
	"TMP"	NUMBER		 NULL
);
