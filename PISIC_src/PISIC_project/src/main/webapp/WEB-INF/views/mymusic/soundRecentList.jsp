...
$(function(){
    ...
    $("#select_play").click(function(){
    	if($('input[name=s_no]:checked').length == '0'){
	    	...
	    	// Post 방식으로 새창 열기
	    	window.open('', 'SoundPlayer', 'top=10, left=10, width=500, height=700, status=no, menubar=no, toolbar=no, resizable=no');
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="title_div">
						<h2 class="card-title">최근 들은 노래</h2>
						<p class="text-muted mb-0">*최근 7일간 들은 노래입니다.</p>
					</div>
							...
							<div class="card-body">
								<table class="table intro_table">
									...
									<tbody>
										...
										<tr>
											<td>수록곡 :</td>
											<td>${selectSoundRecentTotalCnt} 곡</td>
										</tr>
									</tbody>
								</table>
							</div>
											...
											<table class="table sound_list">
												...
												<tbody>
													<c:choose>
														...
														<tr>
															<td colspan="8" style="text-align: center"><h4 class="card-title">들은 곡이 없어요</h4></td>
														</tr>
														</c:when>
														<c:otherwise>
