		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<br>
					<h3 class=" card-title">자주묻는 문의글 수정</h3>
										...
										<form id="writeform" action="<%=request.getContextPath()%>/faq/updateFaq" method="post">
										 ...
										 <input type="hidden" value="${faqBoard.faq_date}" name="faq_date">
											...
											<div  class="form-group">
												...
												placeholder="(자주 묻는 질문을 등록해주세요)">${faqBoard.faq_title }</textarea>
											</div>
											
											<div  class="form-group">	
												<label  for="faq_content">문의 답변 내용</label>            
												<textarea  class="form-control" id="faq_content" name="faq_content" maxlength="2048" 
