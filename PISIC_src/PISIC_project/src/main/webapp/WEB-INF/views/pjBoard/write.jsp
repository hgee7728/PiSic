...
$(function() {
	...
	$("#submit_btn").click(function(){
	    	...
	    	checkFlag = true;
	    	if(checkFlag){
		    	var confm = confirm("입력한 내용으로 글을 쓰시겠습니까?");
		    	if (confm == false) {
		    		alert("취소하셨습니다.");
		    	} else {
		    		board_frm.action = root_path + "/pjBoard/write";
    ...
    $("#cancel_btn").click(function(){
    	var confm = confirm("글쓰기를 취소 하시겠습니까? 입력한 내용이 모두 사라집니다.");
    	if (confm == false) {
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<div class="title_div">
						<h2 class="card-title">Pj Lounge 글쓰기</h2>
					</div>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" placeholder="Name" name="b_title">
					</div>
					<div class="form-group">
						<label for="b_content" id="label_b_content">소개글*</label>
						<textarea class="form-control" rows="10" placeholder="(최대 한글 150자)" id="b_content" name="b_content" maxlength="150"></textarea>
					</div>
