...
<body>
	...
	<div class="map_wrap">
		<div id="map"
			style="width: 500px; height: 500px; position: fixed; overflow: hidden;"></div>
		<div class="hAddr">
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=7a7bf195d5cc90672cc59dc463b6d3e9&libraries=services"></script>
	<script>
