            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <label class="card-description">아이디 찾기</label>
                    <c:if test="${not empty msg}">
                    	<span id="SpanErrormsg"><i class="mdi mdi-close"></i>${msg}</span>
                    </c:if>
                    <form id="findIdForm" class="forms-sample" action="<%=request.getContextPath() %>/findId" method="post">
                      <!-- csrf 공격 방지 -->
